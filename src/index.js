...
function showCountryFlagName(data) {
  ...
  countryDescription.classList.add('country-list__name');
...
function showCountryData(obj, targetPlace) {
  ...
  for (const key of keys) {
    ...
    insertHeaderData.classList.add('country-list__heading');

    const insertHeaderDetails = document.createElement('span');
    insertHeaderDetails.classList.add('country-list__details');
...
function showUnfold(el) {
  ...
  el.classList.add('country-list__item--unfold');
...
document.body.addEventListener('click', e => {
  ...
  if (
    !e.target.classList.contains('country-list__item--unfold') &&
    ...
    fetchCountries(e.target.textContent) //getting data from promise
      .then(data => {
        ...
        e.target.classList.add('country-list__item--unfold');
      });
  ...
  if (e.target.classList.contains('country-list__item--unfold')) {
    e.target.classList.toggle('country-list__item--unfold');
